...
import 'package:socieaty/features/transaction/customer/viewstate/chat_view_state.dart';
...
class ChatViewModel extends _$ChatViewModel {
  ...
  Future<void> createMessage(String orderId, String message) async {
    ...
    final result = await _transactionRepository.createFoodOrderTransactionMessage(orderId, message);
    switch(result){
