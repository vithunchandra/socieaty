...
part 'get_all_unverified_restaurant_provider.g.dart';

@riverpod
Future<List<SocieatyRestaurant>> getAllUnverifiedRestaurant(Ref ref, GetAllUnverifiedRestaurantRequestQuery query) async {
  final repository = ref.watch(restaurantRespositoryProvider);
  final result = await repository.getAllUnverifiedRestaurant(query);
  switch (result) {
