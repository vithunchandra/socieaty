...
class CreatePostCommentResponse with _$CreatePostCommentResponse {
  const factory CreatePostCommentResponse({
    required Post updatedPost,
    required PostComment comment,
  }) = _CreatePostCommentResponse;

  factory CreatePostCommentResponse.fromJson(Map<String, dynamic> json) =>
      _$CreatePostCommentResponseFromJson(json);
}
