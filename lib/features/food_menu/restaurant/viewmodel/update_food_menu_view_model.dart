...
import 'package:socieaty/features/food_menu/restaurant/viewstate/update_food_menu_view_state.dart';
  ...
  Future<void> updateFoodMenu(UpdateFoodMenuFormState data, File? menuPicture) async {
    ...
    switch (result) {
      ...
      case Error(error: final error):
        state = state.copyWith(updateMenuState: ErrorState(message: error.message));
    }
  }
}
