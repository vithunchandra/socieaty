...
part 'get_customer_reservations_provider.g.dart';

@riverpod
Future<List<Reservation>> getCustomerReservations(
    Ref ref, GetReservationsHistoryQueryState queryState) async {
