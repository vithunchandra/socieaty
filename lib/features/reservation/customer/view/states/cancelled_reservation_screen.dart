...
class CancelledReservationScreen extends StatefulWidget {
  final Reservation reservation;
  final VoidCallback onBackToHome;
  final VoidCallback onContactSupport;

  const CancelledReservationScreen({
    super.key,
  ...
  @override
  State<CancelledReservationScreen> createState() => _CancelledReservationScreenState();
}

class _CancelledReservationScreenState extends State<CancelledReservationScreen>
          ...
          children: [
            ...
            FadeTransition(
              ...
              child: Padding(
                ...
                child: Text(
                  'Reservasi Anda telah dibatalkan. Silakan hubungi layanan pelanggan untuk informasi lebih lanjut.',
