...
part 'get_reservations_query.freezed.dart';
part 'get_reservations_query.g.dart';

@freezed
class GetReservationsQuery with _$GetReservationsQuery {
  const factory GetReservationsQuery({
  ...
  }) = _GetReservationsQuery;

  factory GetReservationsQuery.fromJson(Map<String, dynamic> json) => _$GetReservationsQueryFromJson(json);
}
